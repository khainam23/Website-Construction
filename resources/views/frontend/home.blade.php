...
<div class="container">
    ...
    <div class="product">
        ...
        <div class="product-list row">
            ...
            <a class="col-md-4 mb-4 text-decoration-none" href="{{ route('web.product.detail', ['id' => $product->id]) }}">
                <div class="product-card border border-success-subtle rounded-3 p-3 transition d-flex flex-column h-100">
