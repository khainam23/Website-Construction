    ...
    <div class="section">
        <div class="container">
            ...
            <div class="section-header">
                ...
                <div class="logo">
                    <img class="logo-in" src="{{ asset('frontendcss/images/logo-product-detail1.png') }}" alt="logo">
                </div>
            </div>
            <div class="content">
                <div class="left">
                    ...
                    <div class="tabs">
                        ...
                        <div class="container mt-4">
                            ...
                            <ul class="nav custom-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="thi-cong-tab" data-toggle="tab" href="#thi-cong"
                                        role="tab" aria-controls="thi-cong" aria-selected="true">
                                        <strong>{{ __('Construction') }}</strong>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="trach-nhiem-tab" data-toggle="tab" href="#trach-nhiem"
                                        role="tab" aria-controls="trach-nhiem" aria-selected="false">
                                        {{ __('Responsibility') }}
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content mt-0" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="thi-cong" role="tabpanel"
                                    aria-labelledby="thi-cong-tab">
                                    <div>
                                ...
                                <div class="tab-pane fade" id="trach-nhiem" role="tabpanel"
                                    aria-labelledby="trach-nhiem-tab">
                                    <div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach($products as $product)
                            <div class="swiper-slide">
                                <a class="link" href="{{ route('web.product.detail', ['id' => $product->id]) }}">
                                    <div>
                                        <img class="img-slide" src="{{asset($product->avatar)}}"
                                            alt="Phụ gia bê tông BMQ - Plas 02">
                                    </div>
                                    <h4 class="name-product-1">{{$product->name}}</h4>
                                    <p class="content-product-1">{!!$product->description!!}</p>
                                </a>
                            </div>
                        @endforeach
                    </div>
